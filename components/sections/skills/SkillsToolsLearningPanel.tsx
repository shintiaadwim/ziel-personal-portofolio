import { learningTools } from "@/data/skillsData";
import TagBadge from "../../ui/TagBadge";

export default function SkillsToolsLearningPanel() {
    return (
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-700 p-5 shadow-sm dark:bg-zinc-900">
            <h3 className="text-base font-semibold text-zinc-900 dark:text-white sm:text-sm">Tools I Want to Learn</h3>
            <p className="mt-1 text-base text-zinc-600 dark:text-zinc-400 sm:text-sm">
